        ...
        <div className="footer-content">
          <div className="footer-grid">
            <div className="footer-brand">
              <Logo />
              <p>
                PromptCue is your universal AI chat interface, bringing together
                the world&apos;s best AI models in one seamless experience.
              </p>
            </div>
            ...
            <div className="footer-section">
              ...
              <div className="footer-links">
                ...
                <Link href="/product/docs">Documentation</Link>
              </div>
            </div>
            ...
            <div className="footer-section">
              ...
              <div className="footer-links">
                ...
                <Link href="/legal/tnc">Terms & Conditions</Link>
              </div>
            </div>
          </div>
          ...
          <div className="footer-bottom">
            <div className="footer-bottom-left">
              &copy; {new Date().getFullYear()} PromptCue. All rights reserved.
            </div>
